...
class SendtoSilhouette(EffectExtension):
    ...
    def effect(self):
        ...
        reg_origin_X = self.options.regoriginx or self.doc_reg_x
        reg_origin_Y = self.options.regoriginy or self.doc_reg_y
        reg_width = self.options.regwidth or self.doc_reg_width or self.svg.to_dimensional(self.svg.viewport_width, "mm") - reg_origin_X * 2
        reg_length = self.options.reglength or self.doc_reg_length or self.svg.to_dimensional(self.svg.viewport_height, "mm") - reg_origin_Y * 2
        self.report(f"Using Registration Mark:: mark distance from document: Left={reg_origin_X}mm, Top={reg_origin_Y}mm; mark to mark distance: X={reg_width}mm, Y={reg_length}mm;", 'log')

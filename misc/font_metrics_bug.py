...
Text(parent=root, x=0, y=0,  text="TooT, World", font="6")
Text(parent=root, x=0, y=8, text="TooT, World", font="sans 9")
Text(parent=root, x=0, y=20, text="TooT, World", font="Arial 12")
Text(parent=root, x=0, y=30, text="TooT, World", font="24")
